...
if(!class_exists('AffinityMikadoSidebar')) {

	class AffinityMikadoSidebar {
		...
		function __construct() {
			...
			$this->title  = esc_html__('Custom Widget Area', 'affinity');
		...
		function load_assets() {
			...
			wp_enqueue_script('affinity-mikado-sidebar', MIKADO_ROOT.'/framework/admin/assets/js/mkd-sidebar.js');
			wp_enqueue_style('affinity-mikado-sidebar', MIKADO_ROOT.'/framework/admin/assets/css/mkd-sidebar.css');
		}
		...
		function template_add_widget_field() {
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'affinity')."' name='mkd-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'affinity')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars() {
			...
			$args = apply_filters('affinity_mikado_custom_widget_args', $args);
