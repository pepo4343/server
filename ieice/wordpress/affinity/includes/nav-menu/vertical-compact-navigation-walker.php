 ...
 */
if (!class_exists('AffinityMikadoVerticalCompactNavigationWalker')) {
	class AffinityMikadoVerticalCompactNavigationWalker extends Walker_Nav_Menu {
		...
		function start_lvl(&$output, $depth = 0, $args = array()) {
			...
			if ($depth == 0) {
				$out_div = '<div class="second ' . $background_image_class . '" ' . affinity_mikado_get_inline_style($menu_image_background) . '><div class="inner">';
			} else {
				$out_div = '';
			}
