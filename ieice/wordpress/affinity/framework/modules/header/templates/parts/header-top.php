<?php if($show_header_top) : ?>
	...
	<?php do_action('affinity_mikado_before_header_top'); ?>
    <?php if($show_header_top_background_div){ ?>
        <div class="mkd-top-bar-background <?php echo esc_attr($gradient_class); ?>"></div>
    <?php } ?>
	<div class="mkd-top-bar">
		<?php if($top_bar_in_grid) : ?>
		<div class="mkd-grid">
			<?php endif; ?>
			<?php do_action('affinity_mikado_after_header_top_html_open'); ?>
	...
	<?php do_action('affinity_mikado_after_header_top'); ?>
