...
class HeaderTabbed extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
			...
			$menuAreaHeight       = affinity_mikado_filter_px(affinity_mikado_options()->getOptionValue('menu_area_height_header_tabbed'));
	...
	public function headerPerPageStyles($style) {
		...
		$main_menu_selector = array($class_prefix.'.mkd-header-tabbed .mkd-menu-area');


        /* header style - start */

		$menu_area_background_color        = get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true);
		$menu_area_background_transparency = get_post_meta($id, 'mkd_menu_area_background_transparency_header_tabbed_meta', true);
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters = apply_filters('affinity_mikado_header_tabbed_parameters', $parameters);
	...
	public function calculateHeightOfTransparency() {
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true) !== '') {
			$menuAreaTransparent = get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true) !== '' &&
			                       get_post_meta($id, 'mkd_menu_area_background_transparency_header_tabbed_meta', true) !== '1';
		} else {
			$menuAreaTransparent = affinity_mikado_options()->getOptionValue('menu_area_background_color_header_tabbed') !== '' &&
			                       affinity_mikado_options()->getOptionValue('menu_area_background_transparency_header_tabbed') !== '1';
		}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		if(get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true) !== '') {
			$menuAreaTransparent = get_post_meta($id, 'mkd_menu_area_background_color_header_tabbed_meta', true) !== '' &&
			                       get_post_meta($id, 'mkd_menu_area_background_transparency_header_tabbed_meta', true) === '0';
		} else {
			$menuAreaTransparent = affinity_mikado_options()->getOptionValue('menu_area_background_color_header_tabbed') !== '' &&
			                       affinity_mikado_options()->getOptionValue('menu_area_background_transparency_header_tabbed') === '0';
		}
