...
class HeaderBox extends HeaderType {
	...
	public function __construct() {
		...
		if(!is_admin()) {
			...
			$menuAreaHeight       = affinity_mikado_filter_px(affinity_mikado_options()->getOptionValue('menu_area_height_header_box'));
	...
	public function loadTemplate($parameters = array()) {
		...
		$parameters['menu_area_in_grid'] = affinity_mikado_get_meta_field_intersect('menu_area_in_grid_header_box',$id) == 'yes' ? true : false;

		$parameters = apply_filters('affinity_mikado_header_box_parameters', $parameters);
