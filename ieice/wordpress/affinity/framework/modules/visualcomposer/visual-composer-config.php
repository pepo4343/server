...
if (!function_exists('affinity_mikado_configure_visual_composer')) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function affinity_mikado_configure_visual_composer() {
	...
	add_action('vc_after_init', 'affinity_mikado_configure_visual_composer');

}


if (!function_exists('affinity_mikado_configure_visual_composer_grid_elemets')) {
	...
	function affinity_mikado_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'affinity_mikado_configure_visual_composer_grid_elemets');
}


if (!function_exists('affinity_mikado_configure_visual_composer_frontend_editor')) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function affinity_mikado_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'affinity_mikado_configure_visual_composer_frontend_editor');
}
...
/*** Row ***/
if (!function_exists('affinity_mikado_vc_row_map')) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function affinity_mikado_vc_row_map() {

		$animations = array(
			esc_html__('No animation', 'affinity')                    => '',
			esc_html__('Elements Shows From Left Side', 'affinity')   => 'mkd-element-from-left',
			esc_html__('Elements Shows From Right Side', 'affinity')  => 'mkd-element-from-right',
			esc_html__('Elements Shows From Top Side', 'affinity')    => 'mkd-element-from-top',
			esc_html__('Elements Shows From Bottom Side', 'affinity') => 'mkd-element-from-bottom',
			esc_html__('Elements Shows From Fade', 'affinity')        => 'mkd-element-from-fade'
		);

		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Row Type', 'affinity'),
			'param_name' => 'row_type',
			'value'      => array(
				esc_html__('Row', 'affinity')      => 'row',
				esc_html__('Parallax', 'affinity') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Content Width', 'affinity'),
			'param_name' => 'content_width',
			'value'      => array(
				esc_html__('Full Width', 'affinity') => 'full-width',
				esc_html__('In Grid', 'affinity')    => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Header Style', 'affinity'),
			'param_name' => 'header_style',
			'value'      => array(
				esc_html__('Default', 'affinity') => '',
				esc_html__('Light', 'affinity')   => 'mkd-light-header',
				esc_html__('Dark', 'affinity')    => 'mkd-dark-header'
			),
			'dependency' => array(
				'element' => 'row_type',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Anchor ID', 'affinity'),
			'param_name'  => 'anchor',
			'value'       => '',
			'description' => esc_html__('For example "home"', 'affinity')
		));

		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Content Aligment', 'affinity'),
			'param_name' => 'content_aligment',
			'value'      => array(
				esc_html__('Left', 'affinity')   => 'left',
				esc_html__('Center', 'affinity') => 'center',
				esc_html__('Right', 'affinity')  => 'right'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Video Background', 'affinity'),
			'value'       => array(
				esc_html__('No', 'affinity')  => '',
				esc_html__('Yes', 'affinity') => 'show_video'
			),
			'param_name'  => 'video',
			'description' => '',
			'dependency'  => array(
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Video Overlay', 'affinity'),
			'value'       => array(
				esc_html__('No', 'affinity')  => '',
				esc_html__('Yes', 'affinity') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Video Overlay Image (pattern)', 'affinity'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (webm) File URL', 'affinity'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (mp4) file URL', 'affinity'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'class'       => '',
			'heading'     => esc_html__('Video Background (ogv) file URL', 'affinity'),
			'value'       => '',
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Video Preview Image', 'affinity'),
			'value'       => '',
		...
		vc_add_param("vc_row", array(
			'type'        => 'dropdown',
			'class'       => '',
			'heading'     => esc_html__('Full Screen Height', 'affinity'),
			'param_name'  => 'full_screen_section_height',
			'value'       => array(
				esc_html__('No', 'affinity')  => 'no',
				esc_html__('Yes', 'affinity') => 'yes'
			),
			'save_always' => true,
			'dependency'  => array(
				'element' => 'row_type',
		...
		vc_add_param('vc_row', array(
			'type'       => 'dropdown',
			'class'      => '',
			'heading'    => esc_html__('Vertically Align Content In Middle', 'affinity'),
		...
		vc_add_param('vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__('Section Height', 'affinity'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'attach_image',
			'class'       => '',
			'heading'     => esc_html__('Parallax Background image', 'affinity'),
			'value'       => '',
			'param_name'  => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'affinity'),
			'dependency'  => array(
				'element' => 'row_type',
				'value'   => array('parallax')
			)
		...
		vc_add_param('vc_row', array(
			'type'       => 'textfield',
			'class'      => '',
			'heading'    => esc_html__('Parallax speed', 'affinity'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'dropdown',
			'heading'     => esc_html__('CSS Animation', 'affinity'),
		...
		vc_add_param('vc_row', array(
			'type'        => 'textfield',
			'heading'     => esc_html__('Transition delay (ms)', 'affinity'),
	...
	add_action('vc_after_init', 'affinity_mikado_vc_row_map');
}
